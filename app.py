...
# Set up the UI
st.title(" 🍔 McDeepNet🍔 \n 20k McDonalds Review's 🍔 ")

# Form to take user inputs
with st.form(key='my_form'):
    st.text(" This project contains a Machine Learning (ML) model that is trained on 20,000 \n McDonald's reviews. The ML model uses Recurrent Neural Networks (RNNs) to learn \n patterns from the provided reviews and then, using this learning, generates \n a unique review of its own. The model can produce different types of output \n based on seed text and the 'temperature' set by the user.")
